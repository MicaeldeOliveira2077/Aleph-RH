...
<input type="text" class="form-control" id = "" placeholder ="Digite o Assunto" name="assunto">
 </div>
    <div class="form-group col-md-6">
      <label for="data_agd">Data do compromisso</label>
    <input  type="date" class="form-control" id = "" placeholder ="Digite a data" name="data_agd">
    <div class="form-group">
    <label for="texto">Contexto</label>
    <div class="form-group" >
     <input type="text" class="form-control" id = "" name="texto"">
  </div>
    </div>
